...
@section('title', 'Halaman Employer')
@section('subtitle', 'Menu Employer')
@push('css')
...
@section('content')
    ...
    <div class="pcoded-content">
        ...
        <div class="pcoded-inner-content">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <button type="button" class="btn btn-primary mobtn" data-toggle="modal"
                                            data-target="#modal-employer"><i class="fas fa-plus-circle"></i> Add
                                            Data</button>
            ...
            {{-- Modal Tambah Data --}}
            <div class="modal fade" id="modal-employer" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <form id="form-employer" action="" method="POST">
                        @csrf <!-- Tambahkan token CSRF -->
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Form Input Employer</h4>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <label class="col-form-label" for="nama_employer">Nama Employer</label>
                                        </div>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control " id="nama_employer"
                                                name="nama_employer">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary waves-effect waves-light"
                                    id="btn-save-employer"><i class="fas fa-save"></i> Simpan</button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="modal fade" id="modal-edit" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <form id="form-edit-employer" action="" method="POST">
                        @csrf <!-- Tambahkan token CSRF -->
                        @method('PUT') <!-- Tambahkan method PUT untuk update -->
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Form Edit Employer</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <div class="card-block">
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <label class="col-form-label" for="edit_nama_employer">Nama Kategori
                                                Job</label>
                                        </div>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control "
                                                id="edit_nama_employer" name="nama_employer">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default waves-effect"
                                    data-dismiss="modal">Kembali</button>
                                <button type="button" class="btn btn-primary waves-effect waves-light"
                                    id="btn-update-employer"><i class="fas fa-save"></i> Simpan Perubahan</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script>
        $(document).ready(function() {
            $('#btn-save-employer').click(function() {
                var form = $('#form-employer');
                $.ajax({
                    url: form.attr('action'),
                    type: 'POST',
                    data: form.serialize(),
                    success: function(response) {
                        $('#modal-employer').modal('hide');
                        Swal.fire({
                            title: 'Sukses!',

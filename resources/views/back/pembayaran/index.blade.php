                                            ...
                                            <table id="order-table" class="table table-striped table-bordered nowrap">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="10%">Biaya ID</th>
                                                        <th width="10%">Biaya MCU</th>
                                                        <th width="10%">Bayar Commitment Fee</th>
                                                ...
                                                <tbody>
                                                    @foreach ($pembayaran as $p)
                                                        <tr>
                                                            ...
                                                            <td>Rp. {{ number_format($p->biaya_penempatan, 0, ',', '.') }}</td>
                                                            <td>Rp. {{ number_format($p->biaya_id, 0, ',', '.') }}</td>
                                                            <td>Rp. {{ number_format($p->biaya_mcu, 0, ',', '.') }}</td>

...
@section('title', 'Halaman Reject Diverifikasi')
@section('subtitle', 'Menu Reject Diverifikasi')
@push('css')
    <style>
        .card-sub {
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        ...
                                        <div class="pagination-container d-flex justify-content-center">
                                            {{ $reject_diverifikasi->links('pagination::bootstrap-4') }}
                                        </div>

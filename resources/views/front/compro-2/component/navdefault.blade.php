  ...
  <div class="tw-mx-auto tw-max-w-7xl tw-px-2 sm:tw-px-6 lg:tw-px-8">
    <div class="tw-relative tw-flex tw-h-16 tw-items-center tw-justify-between">
      ...
      <div class="tw-absolute tw-inset-y-0 tw-right-0 tw-flex tw-items-center tw-pr-2 sm:tw-static sm:tw-inset-auto sm:tw-ml-6 sm:tw-pr-0 ">
        ...
        @else
        <a href="{{route('compro-2.login')}}" class="tw-py-1 tw-px-5 tw-text-sky-500 tw-bg-white tw-border tw-border-sky-500 tw-rounded-md tw-mr-5 hover:tw-text-sky-500 hover:tw-scale-105" data-aos="zoom-in" data-aos-duration="700">Masuk</a>
        <a href="{{route('compro-2.daftar')}}" class="tw-py-1 tw-px-5 tw-text-white tw-bg-sky-500 tw-rounded-md hover:tw-text-white hover:tw-scale-105" data-aos="zoom-in" data-aos-duration="700">Daftar</a>
        @endif
      </div>
    </div>
  </div>

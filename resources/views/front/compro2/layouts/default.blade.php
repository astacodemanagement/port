        ...
        <div class="tw-flex tw-flex-1 tw-items-center tw-justify-center sm:tw-items-stretch sm:tw-justify-start">
          ...
          <div class="tw-hidden sm:tw-ml-6 sm:tw-block">
            <div class="tw-flex tw-space-x-4">
              ...
              <a href="#" class="t-font-wo tw-text-sky-500 tw-underline tw-leading-5 tw-rounded-md tw-px-3 tw-py-2 tw-text-sm tw-font-medium">Find Job</a>
              <a href="#" class="tw-text-[#52525B] hover:tw-bg-gray-700 hover:tw-text-white tw-rounded-md tw-px-3 tw-py-2 tw-text-sm tw-font-medium">Employers</a>
            </div>
          </div>
        </div>

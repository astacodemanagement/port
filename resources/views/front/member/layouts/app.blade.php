...
<html lang="en">
    <head>
        ...
        <link id="themeColors" rel="stylesheet" href="{{ asset('member-template/css/style.min.css') }}" />
        <style>body {background-color: #fafafa}@media (min-width: 1300px) {#main-wrapper[data-layout=horizontal][data-sidebar-position=fixed] .body-wrapper>.container-fluid { padding-top: 115px !important } #main-wrapper[data-layout=horizontal] .body-wrapper>.container-fluid, #main-wrapper[data-layout=horizontal] .navbar { max-width: 1500px }}</style>
        @stack('css')
    </head>
    <body>
        <!-- Preloader -->
        <div class="preloader">
            <img src="{{ asset('member-template/images/logos/favicon.ico') }}" alt="loader" class="lds-ripple img-fluid" />
        </div>
        <!-- Body Wrapper -->
            ...
            <header class="app-header">
                <nav class="navbar navbar-expand-xl navbar-light container-fluid px-0">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item d-none d-xl-block">
                            <a href="index.html" class="text-nowrap nav-link">
                                <img src="{{ asset('member-template/images/logos/dark-logo.svg') }}" class="dark-logo" width="180" alt="" />
                                <img src="{{ asset('member-template/images/logos/light-logo.svg') }}" class="light-logo"  width="180" alt="" />
                            </a>
                        </li>
                    </ul>
                    <ul class="navbar-nav quick-links d-none d-xl-flex ms-5">
                        <li class="nav-item dropdown hover-dd d-none d-xl-block ms-5">
                            <a class="nav-link" href="javascript:void(0)" data-bs-toggle="dropdown"><i class="ti ti-user me-3 text-primary fs-5"></i> Profile</a>
                        </li>
                        <li class="nav-item dropdown hover-dd d-none d-xl-block">
                            <a class="nav-link" href="javascript:void(0)" data-bs-toggle="dropdown"><i class="ti ti-briefcase me-3 text-primary fs-5"></i> Jobs</a>
                    ...
                    <div class="d-block d-xl-none">
                        ...
                        <img src="{{ asset('member-template/images/logos/dark-logo.svg') }}" width="180" alt="" />
                        </a>
                    </div>
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link pe-0" href="javascript:void(0)" id="drop1" data-bs-toggle="dropdown" aria-expanded="false">
                                        <div class="d-flex align-items-center">
                                            <div class="user-profile-img">
                                                <img src="{{ asset('member-template/images/profile/user-10.jpg') }}" class="rounded-circle" width="35" height="35" alt="" />
                                            </div>
                                            <h6 class="ms-2 my-2 fw-semibold bg-hover-primary d-none d-lg-block">{{ auth()->user()->name }}</h6>
                                    ...
                                    <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop1">
                                        <div class="profile-dropdown position-relative" data-simplebar>
                                            ...
                                            <img src="{{ asset('member-template/images/profile/user-10.jpg') }}" class="rounded-circle" width="80" height="80" alt="" />
                                            <div class="ms-3">

...
class SeleksiLolosInterviewController extends Controller
{
    ...
    public function updateStatus(Request $request)
    {
        ...
        // Prepare the update data based on the selected status
        $updateData = [
            'status' => $status,
        ];
        ...
        if ($status === 'Batal') {
            ...
            $updateData['tanggal_dari_lolos_interview'] = Carbon::now()->toDateString();
            $updateData['keterangan_dari_lolos_interview'] = $keterangan_dari_lolos_interview;
        }
        ...
        $this->simpanLogHistori('Update', 'Lolos Interview', $seleksi_id, $loggedInUserId, json_encode($oldData), json_encode($updatedData));
    ...
    public function updateStatusMultiple(Request $request)
    {
        ...
        foreach ($selectedIds as $id) {
            ...
            $loggedInUserId = Auth::id();
            $this->simpanLogHistori('Update', 'Lolos Interview', $id, $loggedInUserId, json_encode($seleksi->getOriginal()), json_encode($seleksi));
        }

...

{
    $validator = Validator::make($request->all(), [
        ...
        'fasilitas_id.array' => 'Fasilitas harus berupa array',
        'fasilitas_id.min' => 'Pilih minimal satu fasilitas',
        'ketentuan.min' => 'Ketentuan minimal 6 karakter',
        'deskripsi.min' => 'Deskripsi minimal 6 karakter',
        'pendidikan.min' => 'Pendidikan minimal 6 karakter',
        'tanggal_tutup.date' => 'Tanggal Tutup harus berupa tanggal',
        'masa_percobaan.numeric' => 'Masa Percobaan harus berupa angka',
        'rentang_usia.numeric' => 'Rentang Usia harus berupa angka',
        'level_bahasa.numeric' => 'Level Bahasa harus berupa angka',
        'pengalaman_kerja.numeric' => 'Pengalaman Kerja harus berupa angka',
        'mata_uang_gaji.numeric' => 'Mata Uang Gaji harus berupa angka',
        'kerja_lembur.numeric' => 'Kerja Lembur harus berupa angka',
        'bahasa.numeric' => 'Bahasa harus berupa angka',
        'mitra.numeric' => 'Mitra harus berupa angka',
        'tanggal_tutup.numeric' => 'Tanggal Tutup harus berupa angka',
        'nominal_kurs.numeric' => 'Nominal Kurs harus berupa angka',
        'nominal_kurs.min' => 'Nominal Kurs minimal 6 digit',
